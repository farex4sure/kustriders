                ...
                <div class='flex flex-col h-full gap-y-3 mt-3'>
                    ...
                    <div class='flex w-full justify-between items-center px-3 py-2 md:py-4 md:px-6 bg-white bg-opacity-75'>
                        <div class='flex w-full gap-2'>
                            <div class='flex flex-col w-full justify-between gap-1 items-center'>
                                ...
                                <button class="mt-5 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-12 rounded">
                                    Pay
                                </button>
                            </div>
                        </div>
