...
<html lang="en">
	...
	<body>
        ...
        <section class="py-8 bg-green-300 dark:bg-gray-900">
            <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Payments tool for KUST Riders Wudil</h1>
                    <p class="max-w-2xl mb-6 text-white lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">This software help KUST Wudil Bike rider to ease their registration and monthly payment process.</p>
                    <a href="signup.php" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 dark:focus:ring-green-900">
                        Get started
                ...
                <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <img src="./image/Kustride.png" alt="mockup">
                </div>                
            </div>
        </section>
        ...
        <footer class="p-4 bg-green-300 sm:p-6 dark:bg-gray-900">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="./" class="flex items-center">
                        <img src="./image/Kustride.png" class="mr-3 h-8" alt="FlowBite Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">KUST Riders</span>
                    </a>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" class="hover:underline">Kustrides™</a>. All Rights Reserved.
                </span>
